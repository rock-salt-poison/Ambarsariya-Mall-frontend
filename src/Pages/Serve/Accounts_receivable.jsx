...
function Accounts_receivable() {
  ...
  const cards_data = [
    {id:1, imgSrc : customer_information, title:'Customer Information'},
    {id:2, imgSrc : invoices, title:'Invoices'},
    {id:3, imgSrc : sales_orders_payment, title:'Sales Orders Payment'},
    {id:4, imgSrc : accounts_receivable_ledger, title:'Accounts Receivable Ledger'},
    {id:5, imgSrc : aging_of_receivable, title:' Aging of Receivable'},
    {id:6, imgSrc : credits_and_adjustments, title:' Credits and Adjustments'},
    {id:7, imgSrc : write_offs_and_bad_debts, title:'Write-offs and Bad Debts'},
  ]
  ...
  return (
    ...
    <Box className="accounts_receivable_wrapper">
      ...
      <Header 
        ...
        <Box className="col">
                <Button2 text="Back" redirectTo='../emotional/eshop/financial-management/accounts-payable'/>
                <Button2 text="Next" redirectTo='../emotional/eshop/financial-management/budgeting-and-forecasting'/>
            </Box>
      </Box>  
    </Box>
  )
